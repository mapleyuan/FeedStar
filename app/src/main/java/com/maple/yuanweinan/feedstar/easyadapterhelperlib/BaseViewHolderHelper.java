 ...
 */
package com.maple.yuanweinan.feedstar.easyadapterhelperlib;
...
public class BaseViewHolderHelper {
    ...
    public BaseViewHolderHelper setBackgroundResource(int resource) {
        if (mConvertView == null) {
            return this;
        }
        mConvertView.setBackgroundResource(resource);
        return this;
    }

    public BaseViewHolderHelper setBackground(Drawable drawable) {
        if (mConvertView == null) {
            return this;
        }
        mConvertView.setBackground(drawable);
        return this;
    }

    public BaseViewHolderHelper setOnClickListener(View.OnClickListener l) {
        if (mConvertView == null) {
            return this;
        }
